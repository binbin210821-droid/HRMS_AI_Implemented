...
FIELD_LABELS_VI: dict[str, str] = {
    ...
    "active_task_count": "Số công việc đang đảm nhiệm",
    "active_task_titles": "Tên công việc đang đảm nhiệm",
    "reserved_coordination_count": "Số công việc đã giữ chỗ từ điều phối",
    "workload_count": "Tổng khối lượng công việc trong ngày",
    "available_capacity": "Khả năng nhận thêm trong ngày",
