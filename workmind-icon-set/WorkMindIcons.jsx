...
export const DashboardIcon = (props) => (
  <IconBase {...props}>
    ...
    {[[13.25, 5.5], [5.5, 13.25], [13.25, 13.25]].map(([x, y]) => (
      <rect key={`${x}-${y}`} x={x} y={y} width="5.25" height="5.25" rx="1.6" stroke={colors.primary} strokeWidth="1.7" />
    ))}
  </IconBase>
);
...
export const AlertIcon = (props) => (
  <IconBase {...props} strokeLinecap="round" strokeLinejoin="round">
    <path d="M10.1 4.7 3.4 16.3A2.1 2.1 0 0 0 5.2 19.5h13.6a2.1 2.1 0 0 0 1.8-3.2L13.9 4.7a2.2 2.2 0 0 0-3.8 0Z" fill={colors.soft} stroke={colors.primary} strokeWidth="1.7" />
...
export const EmployeesIcon = (props) => (
  <IconBase {...props} stroke={colors.primary} strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M7.7 18c.6-3.8 2.2-5.6 4.3-5.6s3.7 1.8 4.3 5.6M2.8 17c.4-2.7 1.4-4 2.7-4 .8 0 1.5.4 2 1.2M21.2 17c-.4-2.7-1.4-4-2.7-4-.8 0-1.5.4-2 1.2" strokeWidth="1.7" />
...
export const TasksIcon = (props) => (
  <IconBase {...props} strokeLinecap="round" strokeLinejoin="round">
    <rect x="3.5" y="4" width="14" height="16" rx="4" fill={colors.soft} stroke={colors.primary} strokeWidth="1.7" />
...
export const AiAssistantIcon = (props) => (
  <IconBase {...props} strokeLinecap="round" strokeLinejoin="round">
    <path d="M12 2.8c.7 4.5 2.7 6.5 7.2 7.2-4.5.7-6.5 2.7-7.2 7.2-.7-4.5-2.7-6.5-7.2-7.2 4.5-.7 6.5-2.7 7.2-7.2Z" fill={colors.primary} stroke={colors.primary} strokeWidth="1.2" />
    <path d="M19 15.8c.25 1.7 1 2.45 2.7 2.7-1.7.25-2.45 1-2.7 2.7-.25-1.7-1-2.45-2.7-2.7 1.7-.25 2.45-1 2.7-2.7Z" fill={colors.mid} stroke={colors.primary} strokeWidth="1" />
    <circle cx="5.2" cy="18.3" r="1.5" fill={colors.soft} stroke={colors.primary} strokeWidth="1.4" />
  </IconBase>
);

export const workMindMenuItems = [
  { label: "Tổng quan", icon: DashboardIcon, path: "/dashboard" },
  { label: "Hiệu suất nhân viên", icon: PerformanceIcon, path: "/performance" },
  { label: "Cảnh báo ngưỡng bất lợi", icon: AlertIcon, path: "/alerts" },
  { label: "Nhân viên phòng ban", icon: EmployeesIcon, path: "/employees" },
  { label: "Công việc & deadline", icon: TasksIcon, path: "/tasks" },
  { label: "Trợ lý AI", icon: AiAssistantIcon, path: "/ai-assistant" },
];
